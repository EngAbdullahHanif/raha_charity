...
$child_id = $name = $date = $quantity = $child_name = "";
...
if (isset($_POST['submit'])) {
    ...
    if ($name_err == "" and $quantity_err == "" and $date_err == "") {
        ...
        $result = $child->insert_child_clothes($child_id, $name, $quantity, $date);

        if ($result) {
            header("Location:child_clothes.php?id=".$child_id."&&msg=clo_success");
        } else {
            header("Location:children.php?msg=clo_failed");
        }
    } 
}
...
if (isset($_GET['d-id'])) {
    ...
    $result = $child->delete_stationary_by_id($cloth_id);

    if ($result) {
        header('Location:child_clothes.php?id='.$child_id.'&&msg=delete_success');
    } else {
        header('Location:child_clothes.php?msg=clo_failed');
    }
}
                            ...
                            <div class="col-12">
                                <div class="card text-white m-b-30 ">
                                    <div class="card-body special-card">
                                        ...
                                        <form action="child_clothes.php" method="post" class="">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                      dir="rtl"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $number = 1;
                                            $query = $child->select_child_clothes($child_id);
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="hidden-phone">
                                                    ...
                                                    <a href="child_clothes.php?d-id=<?php echo $child_stationary['give_pro_id']?>&&id=<?php echo $child_id ?>"
