...
$name = $quantity = $date = $unit_quantity = $unit_price =  "";

$name_err = $quantity_err = $date_err = $unit_quantity_err = $unit_price_err = "";
...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['unit_price'])) {
        $unit_price_err = "قیمت واحد الزامی می باشد";
    } else {
    ...
    if ($name_err == "" and $quantity_err == "" and $date_err == "" and $unit_quantity_err == '' ) {
        $insert = $child->insert_red_crescent_purchased($name, $quantity, $date, $unit_quantity, $unit_price);

        if($insert){
            //object successfully inserted
            header("Location:red_crescent.php?msg=red_success");
            
        } else {
            //failed to insert object
            header("Location:red_crescent.php?msg=red_faild");
        }
                                ...
                                <div class="card text-white m-b-30">
                                    <div class="card-body special-card">
                                        ...
                                        <h2 class="mt-0 header-large "
                                            style="text-align: center; margin:15px; padding:10px;"> فرم ثبت اجناس ورودی هلال
                                            احمر</h2>

                                        <form action="red_crescent.php" method="post" class="form-horizontal">
                                                    ...
                                                    <form action="red_crescent.php" method="post"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <label for="example-date-input"
                                                                class="col-sm-4 col-form-label"> تاریخ خرید</label>
                                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group row">
                                                     ...
                                                     <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input class="form-control" type="text"
                                                                value="<?php echo $unit_quantity; ?>" name="unit_quantity">
                                                            <span
                                        ...
                                        <div class="row form-group">
                                            <div class="col-6">
                                                <label for="example-number-input"
                                                        class="col-sm-4 col-form-label">قیمت</label>
                                                    <div class="col-sm-6">
                                                        <input class="form-control" type="text"
                            ...
                            <div class="card-body primary-card">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                  dir="rtl"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <?php
                                            $products = $child->select_red_crescent_purchased();
                                            $number = 1;
