...
<!-- Mirrored from rtl-temp.ir/Theme/Zinzer/vertical-rtl/pages-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Jun 2019 05:46:51 GMT -->
<?php 
    ...
    <body class="fixed-left">
        ...
        <div class="home-btn d-none d-sm-block">
            <a href="index-2.html" class="text-dark"><i class="mdi mdi-home h1"></i></a>
        </div>
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal m-t-20" action="https://themesdesign.in/zinzer_1/vertical-rtl/index.html">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <input class="form-control" type="email" required="" placeholder="ایمیل">
                                            </div>
                                        </div>
