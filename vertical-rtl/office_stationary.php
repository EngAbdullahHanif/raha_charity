...
if (isset($_POST['submit'])) {
    ...
    if ($name_err == "" and $quantity_err == "" and $date_err == "") {
        ...
        $result = $child->insert_office_stationary($name, $quantity, $date);

        if ($result) {
            header("Location:office_stationary.php?msg=success");
        } else {
            header("Location:office_stationary.php?msg=sta_failed");
        }
    }
}
                        ...
                        <div class="msg">
                            ...
                            if (isset($_GET['msg'])) {
                                if ($_GET['msg'] == 'success') {
                                    ...
                                    echo "<p style='color: red'>stationary fialed to delete</p>";
                            ...
                            <div class="col-12">
                                <div class="card text-white m-b-30 ">
                                    <div class="card-body special-card">
                                        ...
                                        <h4 class="mt-0 header-large " style="text-align: center; margin:15px; padding:10px;"> فرم ثبت قرطاسیه اداری</h4>

                                        <form action="office_stationary.php" method="post" class="">
                                ...
                                <div class="card-body primary-card">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" dir="rtl" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $number = 1;
                                            $query = $child->select_office_stationary($child_id);
