...
$from_date = $to_date = $type = $donate = "";

$from_date_err = $to_date_err =  $type_err = "";
...
if (isset($_POST['submit'])) {
    ...
    if ($from_date_err == "" and $to_date_err == "" and $type_err == "") {
        if ($type == 'stationary') {
            $sql = $child->select_stationary_date_report($from_date, $to_date);
            if (!empty($_POST['donate'])){
                $sql1 = $child->select_stationary_date_donated_report($from_date, $to_date);
                $donate_result = $sql1->fetch_assoc();
            }
            $result = $sql->fetch_assoc();
        } else {
            $sql = $child->select_clothes_date_report($from_date, $to_date);
            if (!empty($_POST['donate'])){
                $sql1 = $child->select_clothes_date_donated_report($from_date, $to_date);
                $donate_result = $sql1->fetch_assoc();
            }
            $result = $sql->fetch_assoc();
        }
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card text-white m-b-30 ">
                                    <div class="card-body special-card">
                                        ...
                                        <h4 class="mt-0 header-large "
                                            style="text-align: center; margin:15px; padding:10px;"> صفحه راپور اجناس
                                        </h4>
                                        <form action="items_report.php" method="post" class="form-group">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="form-group row col-6">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select class="custom-select" name="type">
                                                            ...
                                                            <option value="stationary" <?php if ($type == 'stationary') {
                                                                                            echo 'selected';
                                                                                        } ?>> قرطاسیه </option>
                                                            <option value="clothes" <?php if ($type == 'clothes') {
                                                                                        echo 'selected';
                                                                                    } ?>> لباس </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group row col-6">
                                                    <label class="col-sm-4 col-form-label"> اهدایه  </label>
                                                        <input type="radio" name="donate" value="donate">
                                                </div>
                                                ...
                                                <h5>از تاریخ <?php echo $from_date ?> الی تاریخ <?php echo $to_date ?>‌
                                                    مجموعا <span
                                                        style="font-size: 23px;"><?php if ($result['quantity'] == NULL) {
                                                                                                                                                                      ...
                                                                                                                                                                      ?></span>
                                                    <?php if ($type == 'stationary') {
                                                                                                                                                                                                                                                                        echo 'اقلام قرطاسیه وارد شده اند';
                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                        echo 'اقلام لباس وارد شده اند';
                                                                                                                                                                                                                                                                    } }?>
                                                </h5>
                                            </div>
                                            <?php endif;?>
                                            
                                            <?php if($from_date != "" and $to_date != "" and $type != "" and $donate != "" ):
                                            ?>
                                            <div class="row mt-3 mr-3">
                                                <h5>از تاریخ <?php echo $from_date ?> الی تاریخ <?php echo $to_date ?>‌
                                                    مجموعا <span
                                                        style="font-size: 23px;"><?php if ($donate_result['quantity'] == NULL) {
                                                                                                                                                                        echo "<span style='color:red;'> هیچ </span>   اقلام اهدا نشده اند";
                                                                                                                                                                    } else {
                                                                                                                                                                        echo $donate_result['quantity'];
                                                                                                                                                                        ?></span>
                                                    <?php if ($type == 'stationary') {                                                                                                                                                                 echo 'اقلام قرطاسیه اهدا شده اند';
                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                        echo 'اقلام لباس اهدا شده اند';
                                                                                                                                                                                                                                                                    } }?>
                                                </h5>
                                            </div>
                                            <?php endif; ?>
                                ...
                                <?php
                                if ($from_date != "" and $to_date != "" and $type == 'stationary') :
                                    ...
                                    <div class="col-12">
                                        <div class="card m-b-30">
                                            <div class="card-body primary-card">
                                                <h4 class="mt-2 header-large mb-3"> راپور اقلام قرطاسیه از تاریخ
                                                ...
                                                <table id="datatable3" class="table table-bordered dt-responsive nowrap" dir="rtl"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th>اسم جنس</th>
                                                            <th>مجموع خریده شده</th>
                                                            <th> مجموع خارج شده</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php
                                                            $query = $child->select_stationary_items();
                                                            while ($item = $query->fetch_assoc()) :
                                                                $query1 = $child->select_stationary_item_date_report($item['id'], $from_date, $to_date);
                                                                $quantity = $query1->fetch_assoc();
                                                                $query2 = $child->select_registration_stationary_given_each_item($item['id'], $from_date, $to_date);
                                                                $left_quantity = $query2->fetch_assoc();

                                                            ?>
                                                        <tr class="odd gradeX">
                                                            <td><?php echo $item['name']; ?></td>
                                                            <td><?php echo $quantity['quantity']; ?></td>
                                                            <td><?php echo $left_quantity['quantity']  ?></td>
                                                        </tr>
                                                        <?php
                                                            endwhile; ?>
                                                    </tbody>
                                ...
                                <?php
                                if ($from_date != "" and $to_date != "" and $type == 'clothes') :
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card m-b-30">
                                            <div class="card-body primary-card">
                                                <h4 class="mt-2 header-large mb-3"> راپور اقلام لباس از تاریخ
                                                    <?php echo $from_date ?> الی تاریخ <?php echo $to_date ?></h4>
												
												<p>
													<input type="button" value="Print Table" onclick="myApp4.printTable4()" />
												</p>
                                                <table id="datatable4" class="table table-bordered dt-responsive nowrap"  dir="rtl"
                                                    style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    <thead>
                                                        <tr>
                                                            <th>اسم جنس</th>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $query = $child->select_clothes_items();
                                                            while ($item = $query->fetch_assoc()) :
                                                                $query1 = $child->select_clothes_item_date_report($item['id'], $from_date, $to_date);
                                                                $quantity = $query1->fetch_assoc();
                                                                $query2 = $child->select_registration_clothes_given_each_item($item['id'], $from_date, $to_date);
                                                                $left_quantity = $query2->fetch_assoc();

                                                            ?>
                                                        <tr class="odd gradeX">
                                                            <td><?php echo $item['name'].' '. $item['season'].' '.$item['type']; ?>
                                                            </td>
                                                            <td><?php echo $quantity['quantity'] ?></td>
                                                            <td><?php echo $left_quantity['quantity'] ?></td>
                                                        </tr>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card m-b-30">
                                            <div class="card-body primary-card">
                                                <h4 class="mt-0 header-large">مجموع اقلام قرطاسیه</h4>
												<p>
													<input type="button" value="Print Table" onclick="myApp.printTable()" />
												</p>
                                                <table id="datatable1" class="table table-bordered dt-responsive nowrap" dir="rtl"
                                                    style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    <thead>
                                                        <tr>
                                                            <th>اسم جنس</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $query = $child->select_stationary_items();
                                                        while ($item = $query->fetch_assoc()) :
                                                            $query1 = $child->select_stationary_item_quantiy($item['id']);
                                                            $quantity = $query1->fetch_assoc();
                                                            $query2 = $child->select_registration_stationary_given_items($item['id']);
                                                            $left_quantity = $query2->fetch_assoc();
                                                        ?>
                                                        <tr class="odd gradeX">
                                                            <td><?php echo $item['name']; ?></td>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card m-b-30">
                                            <div class="card-body primary-card">
                                                <h4 class="mt-0 header-large">مجموع اقلام لباس</h4>
                                                ...
                                                <table id="datatable2" class="table table-bordered dt-responsive nowrap" dir="rtl"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $query = $child->select_clothes_items();
                                                        while ($item = $query->fetch_assoc()) :
                                                            $query1 = $child->select_clothes_item_quantiy($item['id']);
                                                            $quantity = $query1->fetch_assoc();
                                                            $query2 = $child->select_registration_clothes_given_items($item['id']);
                                                            $left_quantity = $query2->fetch_assoc();
                                                        ?>
                                                        <tr class="odd gradeX">
                                                            <td><?php echo $item['name'] . " " . $item['season'] . " " . $item['type']; ?>
