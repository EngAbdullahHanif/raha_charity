...
if (isset($_POST['submit'])) {
    ...
    if ($name_err == "" and $quantity_err == ""  and $type_err == "" and $date_err == "" and $stock_err == "") {

        $result = $child->insert_registeration_products_stationary($name, $stock_id, $quantity, $price, $type, $date);

        if ($result) {
            //Data inserted successfully 
            header('Location:donate_stationary.php?msg=success');
        } else {
            //Data failed to insert
            header('Location:donate_stationary.php?msg=faild');
        }
    } 
}
...
if (isset($_GET['d-id'])) {
    ...
    if ($result) {
        header('Location:donate_stationary.php?msg=delete_success');
    } else {
        header('Location:donate_stationary.php?msg=delete_faild');
    }
}
                            ...
                            <div class="col-12">
                                <div class="card text-white m-b-30 ">
                                    <div class="card-body special-card">
                                        ...
                                        <h4 class="mt-0 header-title"> فرم ثبت قرطاسیه اهدایی</h4>

                                        <form action="donate_stationary.php" method="post" class="form-horizontal">
                                            <?php
                                   ...
                                   <h4 class="mt-0 header-title">جدول اطلاعات</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                      dir="rtl"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $products = $child->select_donated_registeration_product();
                                            $number = 1;
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td<?php if($_SESSION['type'] == 'admin'):  ?> class="hidden-phone">
                                                    ...
                                                    <a href="donate_stationary.php?d-id=<?php echo $product['regis_id'] ?>"
